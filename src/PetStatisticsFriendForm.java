 ...
 * @author Krieolin
 */
public class PetStatisticsFriendForm extends javax.swing.JFrame {

    /**
     * Creates new form PetStatisticsFriendForm
     */

    public  PetStatisticsFriendForm() {
initComponents();
     ...
     Graph<Animal> graph = Filehandlers.GetFromFile();
      ...
      double maleStat = maleFriends/totalFriends * 100;
      double femaleStat = femaleFriends/totalFriends * 100;
      DecimalFormat df = new DecimalFormat("#.##");
      JFreeChart barChart = ChartFactory.createStackedBarChart3D("Pet Statistics",           
         "Likelihood of friendship-  Male:" + df.format(maleStat) + "%    Female: " + df.format(femaleStat) + "%",            
         "Friends",            
         createDataset(),          
   ...
   private CategoryDataset createDataset( ) {
    ...
    public static void runMain()
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PetStatisticsFriendForm().setVisible(true);
                   PetStatisticsFriendForm chart = new PetStatisticsFriendForm();
      chart.pack( );        
