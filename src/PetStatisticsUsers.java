 ...
 * @author Krieolin
 */
public class PetStatisticsUsers extends javax.swing.JFrame {

    /**
     * Creates new form PetStatisticsUsers
     */
    public PetStatisticsUsers() {
        initComponents();
       
      JFreeChart barChart = ChartFactory.createPieChart("Most users", createDataset());         
...
//part of curso pointer
  ...
  private static PieDataset createDataset( ) {
      ...
      for(Edge<Animal> g: graph.getEdges())
      {
          ...
          if(g.getFromVertex().getValue().getType().contains("Dog"))
          {
          dog += 1;
          }
          else if(g.getFromVertex().getValue().getType().contains("Cat"))
          {
          cat+=1;
          }
          else if(g.getFromVertex().getValue().getType().contains("Reptile"))
          {
          reptile+=1;
          }
          else if(g.getFromVertex().getValue().getType().contains("Bird"))
          {
          bird+=1;
          }
          else
      ...
      dataset.setValue("Dogs: " + dog , dog );  
      dataset.setValue("Cats: " + cat , cat );
      dataset.setValue("Reptiles: " + reptile , reptile );
      dataset.setValue("Birds: " + bird , bird );
      dataset.setValue("Other (pigs, llamas, squirrels , etc): " + other , other );
   ...
   public static void runMain()
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PetStatisticsUsers().setVisible(true);
                   PetStatisticsUsers chart = new PetStatisticsUsers();
      chart.pack( );        
