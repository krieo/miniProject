...
public class Graph<T extends Comparable<T>> implements Serializable {
    ...
    public static class Vertex<T extends Comparable<T>> implements Comparable<Vertex<T>>, Serializable {
    ...
    public static class Edge<T extends Comparable<T>> implements Comparable<Edge<T>> , Serializable {
    ...
    public static class CostVertexPair<T extends Comparable<T>> implements Comparable<CostVertexPair<T>> , Serializable {
    ...
    public static class CostPathPair<T extends Comparable<T>> implements Serializable {
